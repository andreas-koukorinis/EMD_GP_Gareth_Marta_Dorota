...
\input{IMF_definition_GP}
\input{multiple_trials_denoising}
\input{GP_formulation_splines}
\input{EMD_background}
\input{EMD_Feature_Extraction}
\input{kernel_choice}
%\input{estimation_params}
\input{IMF_Brownian_Bridge}
\input{Kernel_Target_Alignment}

%\input{appendix_IMF-coeff}
